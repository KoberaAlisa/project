package com.kobera.votingsystem.web.rest.v1;
...
import com.kobera.votingsystem.util.mapper.RestaurantMapper;
import com.kobera.votingsystem.web.AbstractRestControllerTest;
...
import static com.kobera.votingsystem.RestaurantTestHelper.*;
import static com.kobera.votingsystem.UserTestHelper.ADMIN;
import static com.kobera.votingsystem.UserTestHelper.USER1;
import static com.kobera.votingsystem.config.WebConfig.REST_V1;
import static com.kobera.votingsystem.web.json.JsonUtil.readValue;
import static com.kobera.votingsystem.web.json.JsonUtil.writeValue;
...
class RestaurantControllerTest extends AbstractRestControllerTest {
    ...
    void getAll() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(REST_URL)
                ...
                .andExpect(content().json(writeValue(RESTAURANTS), true));
    }
    ...
    void get() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(REST_URL + RESTAURANT1_ID)
                ...
                .andExpect(status().isOk())
                .andExpect(content().contentTypeCompatibleWith(MediaType.APPLICATION_JSON))
                .andExpect(content().json(writeValue(RESTAURANT1), true));
    }
