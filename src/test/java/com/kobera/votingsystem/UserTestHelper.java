...
import com.kobera.votingsystem.web.json.JsonUtil;

import java.util.List;

import static com.kobera.votingsystem.model.AbstractBaseEntity.START_SEQ;
...
public class UserTestHelper {
    ...
    public static final UserDto USER2_DTO = new UserDto(USER2_ID, "User2", "user2@yandex.ru", "password");
